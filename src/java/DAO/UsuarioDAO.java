...
public void cadastraNovoUsuario(Usuario usuario) {
    ...
    public Usuario autenticaUsuario(Usuario usuario) {
        ...
        if (rsUsuario.next()) {
            ...
            usuarioAutenticado.setDtnasc(rsUsuario.getString("dtnasc"));
            usuarioAutenticado.setTelefone(rsUsuario.getString("tel"));
            ...
            usuarioAutenticado.setStatus(rsUsuario.getBoolean("status"));
