...
public class EnderecoDAO {
    ...
    private static final String CADASTRA_ENDERECO = "INSERT INTO endereco(logradouro, cep, numero, bairro, cidade, estado, usuario) VALUES (?,?,?,?,?,?,?)";
    ...
    private static final String CONSULTAR_POR_USUARIO = "SELECT * FROM endereco WHERE usuario = ?";
...
public void cadastrarEndereco(Endereco endereco) {
    ...
    pstmt.setInt(7, endereco.getUsuario().getId());
   ...
   public List<Endereco> listar() {
    ...
    public Endereco ConsultaUsuario (Endereco endereco){
        ...
        try{
            ...
            while(rs.next()){
                ...
                enderecoConsulta.setUsuario(usuario);
